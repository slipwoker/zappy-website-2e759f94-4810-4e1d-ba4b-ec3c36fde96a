  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      for (let i = 0; i < rules.length; i++) {
        const rulePart = rules[i];
        const [ruleName, ruleValue] = rulePart.split(':');

        if (validators[ruleName]) {
          const isValid = validators[ruleName](field.value, ruleValue);
          if (!isValid) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "סקוויש לי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2e759f94-4810-4e1d-ba4b-ec3c36fde96a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2e759f94-4810-4e1d-ba4b-ec3c36fde96a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2e759f94-4810-4e1d-ba4b-ec3c36fde96a';
